...
require_once("include/comportamental_comun_2_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "comportamental_comun_2" );
