...
require_once("include/concertacion_po_3se_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "concertacion_po_3se" );
