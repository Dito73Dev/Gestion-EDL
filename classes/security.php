...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "gestionedl_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	*  For AD it is <provider code><username>
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestionedl_ugmembers", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgGroupsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestionedl_uggroups", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgRightsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestionedl_ugrights", $cman->getUserGroupsConnId() );
	}
	...
	public static function  fillTablesOwnerId( $data, $provider ) {
		...
		if( $securityType == stAD && !$provider["useDbGroups"] ) {
			...
			storageSet( "_concertacion_po_OwnerID", $userId );
						storageSet( "_concertacion_po_2_OwnerID", $userId );
						storageSet( "_concertacion_po_3_OwnerID", $userId );
						storageSet( "_concertacion_po_3s_OwnerID", $userId );
						storageSet( "_concertacion_po_3se_OwnerID", $userId );
						storageSet( "_q_caldef_p_x005_OwnerID", $userId );
						storageSet( "_q_caldef_p_x005_evaluador_OwnerID", $userId );
		} else {
						storageSet( "OwnerID", $data["usuario"] );
			storageSet( "_concertacion_po_OwnerID", $data["usuario"] );
						storageSet( "_concertacion_po_2_OwnerID", $data["usuario"] );
						storageSet( "_concertacion_po_3_OwnerID", $data["idFuncionario"] );
						storageSet( "_concertacion_po_3s_OwnerID", $data["idFuncionario"] );
						storageSet( "_concertacion_po_3se_OwnerID", $data["idFuncionario"] );
						storageSet( "_q_caldef_p_x005_OwnerID", $data["id"] );
						storageSet( "_q_caldef_p_x005_evaluador_OwnerID", $data["idFuncionario"] );
		}
	}
