...
require_once("include/compromisofuncional_th_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "compromisofuncional_th" );
