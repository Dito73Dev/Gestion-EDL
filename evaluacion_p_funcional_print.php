...
require_once("include/evaluacion_p_funcional_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "evaluacion_p_funcional" );
