...
$tdatadependencias_001[".pagesByType"] = my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" );
$tdatadependencias_001[".originalPagesByType"] = $tdatadependencias_001[".pagesByType"];
$tdatadependencias_001[".pages"] = types2pages( my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" ) );
$tdatadependencias_001[".originalPages"] = $tdatadependencias_001[".pages"];
$tdatadependencias_001[".defaultPages"] = my_json_decode( "{\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\"}" );
