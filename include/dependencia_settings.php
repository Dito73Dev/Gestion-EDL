...
$tdatadependencia[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" );
$tdatadependencia[".originalPagesByType"] = $tdatadependencia[".pagesByType"];
$tdatadependencia[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" ) );
$tdatadependencia[".originalPages"] = $tdatadependencia[".pages"];
$tdatadependencia[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"search\":\"search\"}" );
...
$tdatadependencia[".badgeColor"] = "D2AF80";
