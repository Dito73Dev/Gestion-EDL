...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connName"] = "edl_user at 127.0.0.1";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;127.0.0.1;root;1qaz2wsx;3307;edl_sp;;1"; //currently unused

		$this->_connectionsIdByName["edl_user at 127.0.0.1"] = "edl_at_127_0_0_1";
		...
		$data["connInfo"][4] = "edl_sp";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 8.0 Unicode Driver};Server=127.0.0.1;Uid=root;Pwd=1qaz2wsx;Port=3307;Database=edl_sp;OPTION=3";
		// encription set
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "edl2_at_127_0_0_1";
		$data["connName"] = "edl_sp at 127.0.0.1";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;127.0.0.1;root;1qaz2wsx;3307;edl_sp;;1"; //currently unused

		$this->_connectionsIdByName["edl_sp at 127.0.0.1"] = "edl2_at_127_0_0_1";
		...
		$connectionsData["edl2_at_127_0_0_1"] = $data;
