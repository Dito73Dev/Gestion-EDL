...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("cargo" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion" == $this->chrt_array['tables'][0])
			return true;
		if("usuario" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_vigencia" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_periodo" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_estados_eval" == $this->chrt_array['tables'][0])
			return true;
		...
		if("nombramiento" == $this->chrt_array['tables'][0])
			return true;
		if("compromisofuncional" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tipoacuerdo" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_estados_compromisos" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_ponderacion" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion" == $this->chrt_array['tables'][0])
			return true;
		if("q_edl2_ctrl_valor_af_002" == $this->chrt_array['tables'][0])
			return true;
		if("comportamental_comun" == $this->chrt_array['tables'][0])
			return true;
		if("comportamental_jerarquica" == $this->chrt_array['tables'][0])
			return true;
		if("comportamental" == $this->chrt_array['tables'][0])
			return true;
		if("competencia" == $this->chrt_array['tables'][0])
			return true;
		if("conducta" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_puntaje" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion" == $this->chrt_array['tables'][0])
			return true;
		if("compromisofuncional" == $this->chrt_array['tables'][0])
		...
		if("evaluacion" == $this->chrt_array['tables'][0])
			return true;
		if("help" == $this->chrt_array['tables'][0])
			return true;
		if("q_graph_estado" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion" == $this->chrt_array['tables'][0])
			return true;
		if("comportamental_jerarquica" == $this->chrt_array['tables'][0])
		...
		if("compromisofuncional" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion_p" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_estados_evaluacion_p" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_vigencia_eval" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion_p_comportamental" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion_p_funcional" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion_p" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_estados_calificacion" == $this->chrt_array['tables'][0])
			return true;
		if("evidencias_p" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion_seguimiento" == $this->chrt_array['tables'][0])
			return true;
		if("q_caldef_p_x005" == $this->chrt_array['tables'][0])
			return true;
		if("q_global_evaluadores" == $this->chrt_array['tables'][0])
			return true;
		if("evaluacion" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_estados" == $this->chrt_array['tables'][0])
			return true;
		if("calificacion_definitiva" == $this->chrt_array['tables'][0])
			return true;
		...
		if("evidencias_p" == $this->chrt_array['tables'][0])
			return true;
		if("evaluador_final" == $this->chrt_array['tables'][0])
			return true;
		if("q_caldef_p_x005" == $this->chrt_array['tables'][0])
			return true;
		if("q_global_users_edl2" == $this->chrt_array['tables'][0])
			return true;
		if("q_global_evaluadores_edl2" == $this->chrt_array['tables'][0])
			return true;
		if("gestionedl_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("gestionedl_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("usuario" == $this->chrt_array['tables'][0])
			return true;
		if("funcionario" == $this->chrt_array['tables'][0])
