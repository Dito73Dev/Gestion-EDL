...
require_once("include/calificacion_definitiva_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "calificacion_definitiva" );
