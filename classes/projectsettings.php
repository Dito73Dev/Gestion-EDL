...
function fillProjectEntites()
{
	...
	$projectEntities[ "concertacion_po" ] = array( "url" => "concertacion_po", "type" => 1 );
	$projectEntitiesReverse[ "concertacion_po" ] = "concertacion_po";
	...
	$projectEntities[ "tparam_periodo" ] = array( "url" => "tparam_periodo", "type" => 0 );
	$projectEntitiesReverse[ "tparam_periodo" ] = "tparam_periodo";
	$projectEntities[ "tparam_estados_eval" ] = array( "url" => "tparam_estados_eval", "type" => 0 );
	$projectEntitiesReverse[ "tparam_estados_eval" ] = "tparam_estados_eval";
	...
	$projectEntities[ "compromisofuncional" ] = array( "url" => "compromisofuncional", "type" => 0 );
	$projectEntitiesReverse[ "compromisofuncional" ] = "compromisofuncional";
	$projectEntities[ "tparam_tipoacuerdo" ] = array( "url" => "tparam_tipoacuerdo", "type" => 0 );
	$projectEntitiesReverse[ "tparam_tipoacuerdo" ] = "tparam_tipoacuerdo";
	$projectEntities[ "tparam_estados_compromisos" ] = array( "url" => "tparam_estados_compromisos", "type" => 0 );
	$projectEntitiesReverse[ "tparam_estados_compromisos" ] = "tparam_estados_compromisos";
	$projectEntities[ "tparam_ponderacion" ] = array( "url" => "tparam_ponderacion", "type" => 0 );
	$projectEntitiesReverse[ "tparam_ponderacion" ] = "tparam_ponderacion";
	$projectEntities[ "evaluacion" ] = array( "url" => "evaluacion", "type" => 0 );
	$projectEntitiesReverse[ "evaluacion" ] = "evaluacion";
	$projectEntities[ "q_edl2_ctrl_valor_af_002" ] = array( "url" => "q_edl2_ctrl_valor_af_002", "type" => 0 );
	$projectEntitiesReverse[ "q_edl2_ctrl_valor_af_002" ] = "q_edl2_ctrl_valor_af_002";
	$projectEntities[ "comportamental_comun" ] = array( "url" => "comportamental_comun", "type" => 0 );
	$projectEntitiesReverse[ "comportamental_comun" ] = "comportamental_comun";
	$projectEntities[ "comportamental_jerarquica" ] = array( "url" => "comportamental_jerarquica", "type" => 0 );
	$projectEntitiesReverse[ "comportamental_jerarquica" ] = "comportamental_jerarquica";
	$projectEntities[ "comportamental" ] = array( "url" => "comportamental", "type" => 0 );
	$projectEntitiesReverse[ "comportamental" ] = "comportamental";
	$projectEntities[ "competencia" ] = array( "url" => "competencia", "type" => 0 );
	$projectEntitiesReverse[ "competencia" ] = "competencia";
	$projectEntities[ "conducta" ] = array( "url" => "conducta", "type" => 0 );
	$projectEntitiesReverse[ "conducta" ] = "conducta";
	$projectEntities[ "tparam_puntaje" ] = array( "url" => "tparam_puntaje", "type" => 0 );
	$projectEntitiesReverse[ "tparam_puntaje" ] = "tparam_puntaje";
	$projectEntities[ "concertacion_po_2" ] = array( "url" => "concertacion_po_2", "type" => 1 );
	$projectEntitiesReverse[ "concertacion_po_2" ] = "concertacion_po_2";
	$projectEntities[ "compromisofuncional_2" ] = array( "url" => "compromisofuncional_2", "type" => 1 );
	$projectEntitiesReverse[ "compromisofuncional_2" ] = "compromisofuncional_2";
	$projectEntities[ "comportamental_comun_2" ] = array( "url" => "comportamental_comun_2", "type" => 1 );
	$projectEntitiesReverse[ "comportamental_comun_2" ] = "comportamental_comun_2";
	$projectEntities[ "comportamental_jerarquica_2" ] = array( "url" => "comportamental_jerarquica_2", "type" => 1 );
	$projectEntitiesReverse[ "comportamental_jerarquica_2" ] = "comportamental_jerarquica_2";
	$projectEntities[ "concertacion_po_3" ] = array( "url" => "concertacion_po_3", "type" => 1 );
	$projectEntitiesReverse[ "concertacion_po_3" ] = "concertacion_po_3";
	$projectEntities[ "compromisofuncional_3" ] = array( "url" => "compromisofuncional_3", "type" => 1 );
	$projectEntitiesReverse[ "compromisofuncional_3" ] = "compromisofuncional_3";
	$projectEntities[ "comportamental_comun_3" ] = array( "url" => "comportamental_comun_3", "type" => 1 );
	$projectEntitiesReverse[ "comportamental_comun_3" ] = "comportamental_comun_3";
	$projectEntities[ "comportamental_jerarquica_3" ] = array( "url" => "comportamental_jerarquica_3", "type" => 1 );
	$projectEntitiesReverse[ "comportamental_jerarquica_3" ] = "comportamental_jerarquica_3";
	$projectEntities[ "concertacion_po_3s" ] = array( "url" => "concertacion_po_3s", "type" => 1 );
	$projectEntitiesReverse[ "concertacion_po_3s" ] = "concertacion_po_3s";
	$projectEntities[ "concertacion_po_3se" ] = array( "url" => "concertacion_po_3se", "type" => 1 );
	$projectEntitiesReverse[ "concertacion_po_3se" ] = "concertacion_po_3se";
	$projectEntities[ "help" ] = array( "url" => "help", "type" => 0 );
	$projectEntitiesReverse[ "help" ] = "help";
	$projectEntities[ "q_graph_estado Chart" ] = array( "url" => "q_graph_estado_chart", "type" => 3 );
	$projectEntitiesReverse[ "q_graph_estado_chart" ] = "q_graph_estado Chart";
	$projectEntities[ "concertacion_th" ] = array( "url" => "concertacion_th", "type" => 1 );
	$projectEntitiesReverse[ "concertacion_th" ] = "concertacion_th";
	$projectEntities[ "comportamental_jerarquica_th" ] = array( "url" => "comportamental_jerarquica_th", "type" => 1 );
	$projectEntitiesReverse[ "comportamental_jerarquica_th" ] = "comportamental_jerarquica_th";
	$projectEntities[ "comportamental_comun_th" ] = array( "url" => "comportamental_comun_th", "type" => 1 );
	$projectEntitiesReverse[ "comportamental_comun_th" ] = "comportamental_comun_th";
	$projectEntities[ "compromisofuncional_th" ] = array( "url" => "compromisofuncional_th", "type" => 1 );
	$projectEntitiesReverse[ "compromisofuncional_th" ] = "compromisofuncional_th";
	$projectEntities[ "evaluacion_po" ] = array( "url" => "evaluacion_po", "type" => 1 );
	$projectEntitiesReverse[ "evaluacion_po" ] = "evaluacion_po";
	$projectEntities[ "tparam_estados_evaluacion_p" ] = array( "url" => "tparam_estados_evaluacion_p", "type" => 0 );
	$projectEntitiesReverse[ "tparam_estados_evaluacion_p" ] = "tparam_estados_evaluacion_p";
	$projectEntities[ "tparam_vigencia_eval" ] = array( "url" => "tparam_vigencia_eval", "type" => 0 );
	$projectEntitiesReverse[ "tparam_vigencia_eval" ] = "tparam_vigencia_eval";
	$projectEntities[ "evaluacion_p_comportamental" ] = array( "url" => "evaluacion_p_comportamental", "type" => 0 );
	$projectEntitiesReverse[ "evaluacion_p_comportamental" ] = "evaluacion_p_comportamental";
	$projectEntities[ "evaluacion_p_funcional" ] = array( "url" => "evaluacion_p_funcional", "type" => 0 );
	$projectEntitiesReverse[ "evaluacion_p_funcional" ] = "evaluacion_p_funcional";
	$projectEntities[ "evaluacion_p" ] = array( "url" => "evaluacion_p", "type" => 0 );
	$projectEntitiesReverse[ "evaluacion_p" ] = "evaluacion_p";
	$projectEntities[ "tparam_estados_calificacion" ] = array( "url" => "tparam_estados_calificacion", "type" => 0 );
	$projectEntitiesReverse[ "tparam_estados_calificacion" ] = "tparam_estados_calificacion";
	$projectEntities[ "evidencias_p" ] = array( "url" => "evidencias_p", "type" => 0 );
	$projectEntitiesReverse[ "evidencias_p" ] = "evidencias_p";
	$projectEntities[ "evaluacion_seguimiento" ] = array( "url" => "evaluacion_seguimiento", "type" => 0 );
	$projectEntitiesReverse[ "evaluacion_seguimiento" ] = "evaluacion_seguimiento";
	$projectEntities[ "q_caldef_p_x005" ] = array( "url" => "q_caldef_p_x005", "type" => 0 );
	$projectEntitiesReverse[ "q_caldef_p_x005" ] = "q_caldef_p_x005";
	$projectEntities[ "q_global_evaluadores" ] = array( "url" => "q_global_evaluadores", "type" => 0 );
	$projectEntitiesReverse[ "q_global_evaluadores" ] = "q_global_evaluadores";
	$projectEntities[ "evaluacion_x005" ] = array( "url" => "evaluacion_x005", "type" => 1 );
	$projectEntitiesReverse[ "evaluacion_x005" ] = "evaluacion_x005";
	$projectEntities[ "tparam_estados" ] = array( "url" => "tparam_estados", "type" => 0 );
	$projectEntitiesReverse[ "tparam_estados" ] = "tparam_estados";
	$projectEntities[ "calificacion_definitiva" ] = array( "url" => "calificacion_definitiva", "type" => 0 );
	$projectEntitiesReverse[ "calificacion_definitiva" ] = "calificacion_definitiva";
	$projectEntities[ "funcionario" ] = array( "url" => "funcionario", "type" => 0 );
	$projectEntitiesReverse[ "funcionario" ] = "funcionario";
	$projectEntities[ "q_caldef_p_x005_adm" ] = array( "url" => "q_caldef_p_x005_adm", "type" => 1 );
	$projectEntitiesReverse[ "q_caldef_p_x005_adm" ] = "q_caldef_p_x005_adm";
	$projectEntities[ "evaluacion_p_th" ] = array( "url" => "evaluacion_p_th", "type" => 1 );
	$projectEntitiesReverse[ "evaluacion_p_th" ] = "evaluacion_p_th";
	$projectEntities[ "evaluacion_p_funcional_th" ] = array( "url" => "evaluacion_p_funcional_th", "type" => 1 );
	$projectEntitiesReverse[ "evaluacion_p_funcional_th" ] = "evaluacion_p_funcional_th";
	$projectEntities[ "evaluacion_p_comportamental_th" ] = array( "url" => "evaluacion_p_comportamental_th", "type" => 1 );
	$projectEntitiesReverse[ "evaluacion_p_comportamental_th" ] = "evaluacion_p_comportamental_th";
	$projectEntities[ "evidencias_p_th" ] = array( "url" => "evidencias_p_th", "type" => 1 );
	$projectEntitiesReverse[ "evidencias_p_th" ] = "evidencias_p_th";
	$projectEntities[ "evaluador_final" ] = array( "url" => "evaluador_final", "type" => 0 );
	$projectEntitiesReverse[ "evaluador_final" ] = "evaluador_final";
	$projectEntities[ "q_caldef_p_x005_evaluador" ] = array( "url" => "q_caldef_p_x005_evaluador", "type" => 1 );
	$projectEntitiesReverse[ "q_caldef_p_x005_evaluador" ] = "q_caldef_p_x005_evaluador";
	$projectEntities[ "q_global_users_edl2" ] = array( "url" => "q_global_users_edl2", "type" => 0 );
	$projectEntitiesReverse[ "q_global_users_edl2" ] = "q_global_users_edl2";
	$projectEntities[ "q_global_evaluadores_edl2" ] = array( "url" => "q_global_evaluadores_edl2", "type" => 0 );
	$projectEntitiesReverse[ "q_global_evaluadores_edl2" ] = "q_global_evaluadores_edl2";
	...
	$projectEntities[ "funcionario_adm" ] = array( "url" => "funcionario_adm", "type" => 1 );
	$projectEntitiesReverse[ "funcionario_adm" ] = "funcionario_adm";
	$projectEntities[ "usuario_adm" ] = array( "url" => "usuario_adm", "type" => 1 );
	$projectEntitiesReverse[ "usuario_adm" ] = "usuario_adm";
	$projectEntities[ "cargo_adm" ] = array( "url" => "cargo_adm", "type" => 1 );
	$projectEntitiesReverse[ "cargo_adm" ] = "cargo_adm";
	$projectEntities[ "dependencia_adm" ] = array( "url" => "dependencia_adm", "type" => 1 );
	$projectEntitiesReverse[ "dependencia_adm" ] = "dependencia_adm";
	$projectEntities[ "dependencias_sup_adm" ] = array( "url" => "dependencias_sup_adm", "type" => 1 );
	$projectEntitiesReverse[ "dependencias_sup_adm" ] = "dependencias_sup_adm";
