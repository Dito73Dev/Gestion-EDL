...
require_once("include/comportamental_jerarquica_3_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "comportamental_jerarquica_3" );
