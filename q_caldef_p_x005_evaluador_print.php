...
require_once("include/q_caldef_p_x005_evaluador_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_caldef_p_x005_evaluador" );
