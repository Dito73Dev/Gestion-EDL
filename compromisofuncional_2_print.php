...
require_once("include/compromisofuncional_2_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "compromisofuncional_2" );
