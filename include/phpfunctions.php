...
{
	$value = "";
				if($table=="help" && $field=="help_file")
	{
		;
		return $value;
	}
				if($table=="evidencias_p" && $field=="cfe_file")
	{
		;
		return $value;
	}
				if($table=="calificacion_definitiva" && $field=="calificacion_doc")
	{
		;
		return $value;
	}
				if($table=="evidencias_p_th" && $field=="cfe_file")
	{
		;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
		if($table=="concertacion_po" && $field=="estado")
	{
		$strWhere = " estadoeval_id = 1";
		return $strWhere;
	}
		if($table=="compromisofuncional" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="comportamental_comun" && $field=="idComportamental")
	{
		$strWhere = " id= 6";
		return $strWhere;
	}
		if($table=="comportamental_comun" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="comportamental_jerarquica" && $field=="idComportamental")
	{
		$strWhere = " id <> 6";
		return $strWhere;
	}
		if($table=="comportamental_jerarquica" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_2" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_2" && $field=="periodo")
	{
		$strWhere = " periodo_id = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_2" && $field=="estado")
	{
		$strWhere = " estadoeval_id = 2";
		return $strWhere;
	}
		if($table=="compromisofuncional_2" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="comportamental_comun_2" && $field=="idComportamental")
	{
		$strWhere = " id= 6";
		return $strWhere;
	}
		if($table=="comportamental_comun_2" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="comportamental_jerarquica_2" && $field=="idComportamental")
	{
		$strWhere = " id <> 6";
		return $strWhere;
	}
		if($table=="comportamental_jerarquica_2" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_3" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_3" && $field=="periodo")
	{
		$strWhere = " periodo_id = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_3" && $field=="estado")
	{
		$strWhere = " estadoeval_ctrl = 1";
		return $strWhere;
	}
		if($table=="comportamental_comun_3" && $field=="idComportamental")
	{
		$strWhere = " id= 6";
		return $strWhere;
	}
		if($table=="comportamental_jerarquica_3" && $field=="idComportamental")
	{
		$strWhere = " id <> 6";
		return $strWhere;
	}
		if($table=="concertacion_po_3s" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_3s" && $field=="periodo")
	{
		$strWhere = " periodo_id = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_3s" && $field=="estado")
	{
		$strWhere = " estadoeval_id = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_3se" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_3se" && $field=="periodo")
	{
		$strWhere = " periodo_id = 1";
		return $strWhere;
	}
		if($table=="concertacion_po_3se" && $field=="estado")
	{
		$strWhere = " estadoeval_id = 1";
		return $strWhere;
	}
		if($table=="comportamental_jerarquica_th" && $field=="idComportamental")
	{
		$strWhere = " id <> 6";
		return $strWhere;
	}
		if($table=="comportamental_jerarquica_th" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="comportamental_comun_th" && $field=="idComportamental")
	{
		$strWhere = " id= 6";
		return $strWhere;
	}
		if($table=="comportamental_comun_th" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="compromisofuncional_th" && $field=="CFunEstado")
	{
		$strWhere = " estadoc_id = 1";
		return $strWhere;
	}
		if($table=="evaluacion_po" && $field=="id_eval_vigencia_fk")
	{
		$strWhere = " vigencia_st = 1 ";
		return $strWhere;
	}
		if($table=="evaluacion_po" && $field=="estado" && $ptype=="add")
	{
		$strWhere = " estadoeval_id = 1 ";
		return $strWhere;
	}
		if($table=="evaluacion_po" && $field=="estado" && $ptype=="search")
	{
		$strWhere = " estadoeval_id = 1 ";
		return $strWhere;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="concertacion_po" && $field=="idEvaluado")
	{
		return $_SESSION["UID"];
	}
				if($table=="concertacion_po" && $field=="fchCreacion")
	{
				...
				if($table=="concertacion_po" && $field=="estado")
	{
		return 1;
				...
				if($table=="concertacion_po" && $field=="sys_user")
	{
				...
				if($table=="comportamental_jerarquica" && $field=="CFunEstado")
	{
		return 1;
				...
				if($table=="concertacion_po_2" && $field=="idEvaluado")
	{
		return $_SESSION["UID"];
	}
				if($table=="concertacion_po_2" && $field=="periodo")
	{
		return 1;
				...
				if($table=="concertacion_po_2" && $field=="fchCreacion")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="concertacion_po_2" && $field=="estado")
	{
		return 2;
				...
				if($table=="concertacion_po_2" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="compromisofuncional_2" && $field=="CFunEstado")
				...
				if($table=="comportamental_jerarquica_2" && $field=="CFunEstado")
	{
		return 1;
				...
				if($table=="concertacion_po_3" && $field=="idEvaluador")
	{
		return $_SESSION["UID"];
	}
				if($table=="concertacion_po_3" && $field=="periodo")
	{
		return 1;
				...
				if($table=="concertacion_po_3" && $field=="fchCreacion")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="concertacion_po_3" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="comportamental_comun_3" && $field=="idComportamental")
	{
		return 6;
				...
				if($table=="concertacion_po_3s" && $field=="idEvaluador")
	{
		return $_SESSION["UID"];
	}
				if($table=="concertacion_po_3s" && $field=="periodo")
	{
		return 1;
				...
				if($table=="concertacion_po_3s" && $field=="fchCreacion")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="concertacion_po_3s" && $field=="estado")
	{
		return 1;
				...
				if($table=="concertacion_po_3s" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="concertacion_po_3se" && $field=="idEvaluador")
	{
		return $_SESSION["UID"];
	}
				if($table=="concertacion_po_3se" && $field=="periodo")
	{
		return 1;
				...
				if($table=="concertacion_po_3se" && $field=="fchCreacion")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="concertacion_po_3se" && $field=="estado")
	{
		return 1;
				...
				if($table=="concertacion_po_3se" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="q_graph_estado Chart" && $field=="vigencia")
	{
		return strftime("%Y");
	}
				if($table=="concertacion_th" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="comportamental_jerarquica_th" && $field=="CFunEstado")
				...
				if($table=="compromisofuncional_th" && $field=="CFunEstado")
	{
		return 1;
				...
				if($table=="evaluacion_po" && $field=="fchCreacion")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="evaluacion_po" && $field=="estado" && $ptype=="add")
				...
				if($table=="evaluacion_po" && $field=="estado" && $ptype=="search")
	{
		return 1;
				...
				if($table=="evaluacion_po" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="evidencias_p" && $field=="cfe_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="evaluacion_seguimiento" && $field=="SysUser")
	{
		return $_SESSION["UserID"];
	}
				if($table=="calificacion_definitiva" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="calificacion_definitiva" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="evidencias_p_th" && $field=="cfe_user")
	{
		return $_SESSION["UserID"];
	}
	return "";
...
function GetUploadFolderExpression($field, $file, $table )
{
	if($table=="evidencias_p" && $field=="cfe_file")
	{
		$folder = "evidencias/".$_SESSION["UserID"];
;
		return $folder;
	}
	if($table=="calificacion_definitiva" && $field=="calificacion_doc")
	{
		$folder = "calificacion_definitiva/".$_SESSION["UserID"]."/".$_SESSION["V"];
;
		return $folder;
	}
	if($table=="evidencias_p_th" && $field=="cfe_file")
